...
export function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(data.message || "Registrasi berhasil! Silakan cek email verifikasi.");
        ...
        <div className="hidden md:block relative bg-gradient-to-br from-[#2563EB] to-[#3B82F6] p-12">
          <div className="relative z-10 h-full flex flex-col justify-center">
            ...
            <p className="text-blue-100 text-lg mb-8">
              Mulai perjalanan Anda untuk memantau dan memahami risiko hipertensi dengan lebih mudah.
            </p>
        ...
        <div className="p-8 md:p-12 flex flex-col justify-center max-h-screen overflow-y-auto">
          ...
          <div className="mb-3">
            ...
            <p className="text-gray-500">
              Daftar untuk mulai menggunakan Tensio
            </p>
          </div>
