...
export function AdminLayout() {
  ...
  const menuItems = [
    ...
    { path: '/admin/screenings', icon: ClipboardList, label: 'Monitoring Skrining' },
  ];
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <span className="block text-xs text-[#2563EB] font-medium">Admin Panel</span>
              </div>
            </div>
            <button
              onClick={closeSidebar}
          ...
          <div className="px-4 lg:px-8 py-4 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs lg:text-sm text-gray-500">Kelola data dan pengguna Tensio</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 lg:gap-4">
              <div className="hidden md:block text-right mr-3">
                ...
                <p className="text-xs text-[#2563EB] font-medium">Administrator</p>
              </div>
